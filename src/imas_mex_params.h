...
struct imas_mex_params {
  ...
  int convert_whole_ids;                      /*!< If disabled the conversions (int <-> double) and (EMPTY_DOUBLE <-> NaN) will be performed just before/after  calling the lowlevel write/read routines, otherwise they will be performed in one block (default: 0). */

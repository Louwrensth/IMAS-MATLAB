...
struct imas_mex_params {
  ...
  int convert_whole_ids;                      /*!< OBSOLETE. Present behavior corresponds to the old default value (0) where fields were converted just before/after UAL write/read methods. Will be removed in a future release. */
